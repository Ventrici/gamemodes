...
ITEM.description = "A powerful assault weapon that fires explosive kinetic rounds colloquially referred to as bolts."
ITEM.category = "Weapons"
ITEM.model = "models/kali/props/cases/hard case b.mdl"
ITEM.class = "weapon_bolter_pistol"
ITEM.width = 2
ITEM.height = 2
ITEM.isWeapon = true
